/**
 * Navbar.jsx — Top navigation bar with live status indicator.
 */
...
export default function Navbar() {
  ...
  return (
    <nav className="flex items-center justify-between px-6 py-3 border-b border-white/[0.04] bg-dark-800/80 backdrop-blur-lg">
      {/* Brand */}
      ...
      {/* Status Strip */}
      <div className="flex items-center gap-6 px-4 py-2 bg-white/[0.02] border border-white/[0.04] rounded-xl text-[0.7rem] text-gray-500 font-medium">
        <div className="flex items-center gap-2">
